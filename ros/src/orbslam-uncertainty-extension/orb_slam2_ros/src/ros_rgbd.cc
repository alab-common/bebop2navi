...
//    message_filters::Subscriber<sensor_msgs::Image> depth_sub(nodeHandler, "camera/depth_registered/image_raw", 1);
    message_filters::Subscriber<sensor_msgs::Image> rgb_sub(nodeHandler, "/camera/color/image_rect_color", 1);
    message_filters::Subscriber<sensor_msgs::Image> depth_sub(nodeHandler, "/camera/depth/image_rect_raw_resized", 1);
