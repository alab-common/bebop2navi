...
class ROSPublisher :
    ...
    //public ORB_SLAM2::IStateSubscriber
{
public:
    static constexpr const char *DEFAULT_MAP_FRAME = "/camera_world";
    //static constexpr const char *DEFAULT_MAP_FRAME = "camera_world";
    static constexpr const char *DEFAULT_MAP_FRAME_ADJUSTED = "/orb_slam2/map";
    static constexpr const char *DEFAULT_CAMERA_FRAME = "/orb_slam2/frame"; // this is the trajectory guess of the ORB-SLAM2, visualize it in RViz to see trajectory of camera
    ...
    //void SetCurrentState(const ORB_SLAM2::Tracking::eTrackingState &state);
